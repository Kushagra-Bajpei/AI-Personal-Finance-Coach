    ...
    const cardsData = [
        {
            ...
            handle: '@neilstellar',
            date: 'April 20, 2025',
            text: "WealthWise made undercutting all of our competitors an absolute breeze. The AI visualizations are mind-blowing."
        },
        {
            image: avatar2,
            name: 'Avery Johnson',
        ...
        <section className={`py-20 relative overflow-hidden ${dark ? 'bg-[#0a0a0f]' : 'bg-slate-50'}`}>
            ...
            <div className="max-w-7xl mx-auto px-4 mb-12 text-center relative z-20">
                ...
                <p className={`max-w-2xl mx-auto ${dark ? 'text-slate-400' : 'text-slate-600'}`}>
                    Join thousands of users who are exploring their subconscious with WealthWise.
                </p>
            </div>
