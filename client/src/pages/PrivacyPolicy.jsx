...
• **Dream content**: The text descriptions and conversations you share with WealthWise's AI system.
...
• **Business transfers**: In connection with a merger, acquisition, or sale of assets, with appropriate notice.`,
  },
  {
    ...
    content: `We retain your personal information for as long as necessary to provide our services and comply with legal obligations. You may request deletion of your account and associated data at any time by contacting us at privacy@WealthWise.ai or through your account settings.`,
  },
  {
    title: '6. Your Rights',
...
To exercise these rights, contact us at privacy@WealthWise.ai.`,
  },
  {
    title: '7. Security',
  ...
  },
  {
    ...
    content: `We may update this Privacy Policy from time to time. We will notify you of significant changes via email or a prominent notice on our website. Your continued use of WealthWise after changes take effect constitutes your acceptance of the revised policy.`,
  },
  {
    title: '9. Contact Us',
    content: `If you have questions about this Privacy Policy or our data practices, please contact us at:\n\nprivacy@WealthWise.ai\n\nWealthWise Inc., 123 Dream Lane, San Francisco, CA 94105`,
  },
];
        ...
        <div className="max-w-3xl mx-auto px-4 text-center relative">
          <FadeIn>
            ...
            <p className={`text-xl leading-relaxed mt-4 ${dark ? 'text-slate-400' : 'text-slate-600'}`}>
              Your privacy matters to us. This policy explains how WealthWise collects, uses, and protects your information.
            </p>
          </FadeIn>
        </div>
      </section>
