...
const sections = [
  {
    ...
    content: 'Cookies are small text files placed on your device when you visit a website. They help websites remember your preferences, keep you logged in, and understand how you use the site. WealthWise uses cookies and similar technologies (such as local storage) to deliver and improve our services.',
  },
  {
...
Please note that disabling essential cookies will affect your ability to use WealthWise. To manage analytics and functional cookies, please contact us at privacy@WealthWise.ai.`,
  },
  {
  ...
  },
  {
    ...
    content: 'We may update this Cookie Policy from time to time. Any changes will be posted on this page with an updated effective date. If you have questions, contact us at privacy@WealthWise.ai.',
  },
];
