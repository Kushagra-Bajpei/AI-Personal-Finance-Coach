...
import { Heart, Target, Users, Lightbulb, Award, Globe, Shield, TrendingUp, BarChart3, Zap } from 'lucide-react';
...
const values = [
  { icon: BarChart3, title: 'Financial Clarity', col: 'md:col-span-3 lg:col-span-8', desc: 'We transform complex financial data into clear, actionable insights that anyone can understand.', image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&q=80&w=800' },
  { icon: Zap, title: 'AI-First Analysis', col: 'md:col-span-3 lg:col-span-4', desc: "Leveraging state-of-the-art neural engines to predict and optimize your spending patterns.", image: 'https://images.unsplash.com/photo-1639322537228-f710d846310a?auto=format&fit=crop&q=80&w=800' },
  { icon: TrendingUp, title: 'Wealth Growth', col: 'md:col-span-3 lg:col-span-4', desc: 'Our mission is to help you build a sustainable financial future through intelligent coaching.', image: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?auto=format&fit=crop&q=80&w=800' },
  { icon: Shield, title: 'Privacy First', col: 'md:col-span-3 lg:col-span-8', desc: 'Your financial data is sacred. We use bank-grade encryption to ensure your privacy remains absolute.', image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=800' },
  { icon: Award, title: 'Precise Tracking', col: 'md:col-span-3 lg:col-span-6', desc: 'Highest standards in transaction categorization and real-time expense monitoring.', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=800' },
  { icon: Globe, title: 'Inclusive Wealth', col: 'md:col-span-3 lg:col-span-6', desc: "Democratizing professional financial advice for everyone, everywhere in the world.", image: 'https://images.unsplash.com/photo-1553729459-efe14ef6055d?auto=format&fit=crop&q=80&w=800' },
];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <FadeIn>
            ...
            <h1 className={`font-display text-5xl sm:text-6xl font-bold mb-6 ${dark ? 'text-white' : 'text-slate-900'}`}>
              We believe financial freedom{' '}
              <span className="gradient-text">starts with intelligence</span>
            </h1>
            <p className={`text-xl leading-relaxed ${dark ? 'text-slate-400' : 'text-slate-600'}`}>
              WealthWise was founded to bridge the gap between complex financial data and human understanding. We're on a mission to empower every individual with the tools of a professional financial advisor.
            </p>
          </FadeIn>
        </div>
      </section>
              ...
              <div className={`relative group rounded-[3.5rem] overflow-hidden border p-1 ${dark ? 'bg-white/5 border-white/10 shadow-2xl' : 'bg-white border-slate-200 shadow-xl'}`}>
                <div className="relative h-[550px] rounded-[3rem] overflow-hidden">
                    ...
                    <div className="absolute inset-x-12 bottom-12 text-left">
                        ...
                        <h3 className="font-display text-4xl font-black text-white mb-6 leading-[1.1]">Born from <span className="gradient-text">Ambition.</span></h3>
                        <p className="text-white/70 text-base leading-relaxed mb-8 max-w-lg">
                            WealthWise started as a realization: financial tools were either too simple to be useful or too complex to be understood. We built the middle ground—an AI coach that talks like a human but thinks like a quant.
                        </p>
                        <div className="flex gap-4">
                            <div className="px-5 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-2xl">
                                <div className="text-xl font-black text-white">AI First</div>
                                <div className="text-[10px] uppercase text-slate-500 font-black tracking-widest mt-1">Core Logic</div>
                            </div>
                            <div className="px-5 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-2xl">
                                <div className="text-xl font-black text-white">User Centric</div>
                                <div className="text-[10px] uppercase text-slate-500 font-black tracking-widest mt-1">Design Goal</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <FadeIn direction="left" delay={0.2}>
              <div className="text-left relative">
                ...
                <div className="space-y-8">
                    <p className={`text-xl leading-relaxed ${dark ? 'text-slate-400' : 'text-slate-600'}`}>
                    We exist to democratize financial intelligence. In a world of volatile markets and complex spending habits, WealthWise serves as your anchor, providing real-time clarity on where your money goes and how to grow it.
                    </p>
                    <p className={`text-xl leading-relaxed ${dark ? 'text-slate-400' : 'text-slate-600'}`}>
                    As technologists and financial enthusiasts, we're building a future where anyone, regardless of their background, can master their personal economy with the help of artificial intelligence.
                    </p>
                    <Link to="/how-it-works" className="group/btn inline-flex items-center gap-4 text-violet-400 font-black text-sm uppercase tracking-widest pb-2 border-b-2 border-violet-500/20 hover:border-violet-500 transition-all">
                        Master Your Money <Target className="w-5 h-5 group-hover/btn:scale-125 transition-transform" />
                    </Link>
                </div>
              </div>
            </FadeIn>
      ...
      <section className="py-40 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeIn className="text-center mb-32">
            ...
            <p className={`text-2xl max-w-2xl mx-auto ${dark ? 'text-slate-400' : 'text-slate-600'}`}>The principles that guide our journey toward your financial freedom.</p>
          </FadeIn>
